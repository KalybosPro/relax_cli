...
abstract final class ProviderAppTemplate {
  static List<TemplateFile> get files => [
    ...
    TemplateFile(SharedTemplate.p('README.md'), SharedTemplate.readme('Provider', 'notifiers/ → ChangeNotifiers')),

    TemplateFile(SharedTemplate.p('lib/bootstrap.dart'), SharedTemplate.bootstrapProvider),
    ...
    TemplateFile(SharedTemplate.p('lib/features/home/notifiers/home_notifier.dart'), _homeNotifier),
